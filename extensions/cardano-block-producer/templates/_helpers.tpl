...
{{/*
Managed relay StatefulSet and Service base name by ordinal.
*/}}
{{- define "cardano-node.relayName" -}}
{{- printf "%s-relay-%v" (include "cardano-node.fullname" .context) .index | trunc 63 | trimSuffix "-" }}
{{- end }}
