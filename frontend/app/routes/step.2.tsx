...
export default function WizardStep2() {
  ...
  const selectedUtxo: { txHash: string; index: number; } | null = state?.selectedUtxo || null;
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mt-14">
        <Link to="/step/1" className="flex items-center gap-1.25 text-[#2B2B2B]">
        ...
        <Button
          ...
          onClick={() => {
            navigate('/step/3', { state: { selectedUtxo, formValues } });
          }}
        >
          Continue
        </Button>
