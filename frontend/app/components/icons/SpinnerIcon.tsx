...
export function SpinnerIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 18 18" {...props}>
      ...
      <path d="M9 18A9 9 0 1 0 9 0a9 9 0 0 0 0 18m0-1.5a7.5 7.5 0 1 0 0-15 7.5 7.5 0 0 0 0 15" clip-rule="evenodd" />
      <defs>
        <clipPath id="a">
          <path fill-rule="evenodd" d="M9 18A9 9 0 1 0 9 0a9 9 0 0 0 0 18m0-1.5a7.5 7.5 0 1 0 0-15 7.5 7.5 0 0 0 0 15" clip-rule="evenodd" />
        </clipPath>
      </defs>
    </svg>
  );
