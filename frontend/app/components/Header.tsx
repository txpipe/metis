  ...
  return (
    <header className="w-full border-b border-neutral-200 grid grid-cols-[350px_2px_1fr] items-center">
      ...
      {/* <nav className="px-12 flex flex-row gap-8">
        <Link to="/quickstart" data-active className="data-[active]:font-bold">Quickstart</Link>
        <Link to="/marketplace" className="data-[active]:font-bold">Marketplace</Link>
        <Link to="/support" className="data-[active]:font-bold">Support</Link>
      </nav> */}
    </header>
  );
}
