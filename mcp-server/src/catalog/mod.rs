...
impl ExtensionCatalog {
    pub fn embedded() -> Self {
        Self::from_extensions([cardano_node_relay()])
    }
...
fn cardano_node_relay() -> ExtensionDefinition {
    ExtensionDefinition::new(
        ...
        vec!["0.1.0"],
        "0.1.0",
        cardano_node_relay_configuration_schema(),
        vec![],
        vec![],
        cardano_node_relay_metrics_schema(),
        "oci://oci.supernode.store/extensions/cardano-node".to_string(),
    )
}

fn cardano_node_relay_configuration_schema() -> ExtensionConfiguration {
    json!({
...
fn cardano_node_relay_metrics_schema() -> ExtensionMetrics {
...
mod tests {
    ...
    #[test]
    fn embedded_catalog_contains_only_cardano_node_relay() {
        ...
        assert!(catalog.get("dolos").is_none());
    }
