...
const items: CatalogItem[] = [
  ...
  },
  {
    ...
    slug: slugify('SundaeSwap Strategies').toLowerCase(),
    description: 'Deploy your SundaeSwap trading strategies running as bots in your own infrastructure',
    category: 'batcher',
    comingSoon: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Provide serverless middleware to dApp builders. Earn usage-based rewards.',
    category: 'partner-chain',
    comingSoon: true,
  },
  {
