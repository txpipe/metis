...
export function WalletProvider({ children }: { children: ReactNode; }) {
  ...
  const connectWallet = async (walletKey: string) => {
    ...
    // addr_test1vz8jvjmn3zph7uj87nu6hdzkte7pwahjk4r864hug459ncsanyj7c
    const changeAddress = addressToBech32('608f264b7388837f7247f4f9abb4565e7c1776f2b5467d56fc456859e2');
    await new Promise(resolve => setTimeout(resolve, 1000)); // Simulate async delay
    setConnectedWallet({
      getUtxos: () => Promise.resolve([
        // Fake UTxO only with txhash and index
        '818258209ad6ff292db8408a53efc8bf2a9e6815cdc430185a7716cd3ecfc3f81a88f2d600',
        '818258209ad6ff292db8408a53efc8bf2a9e6815cdc430185a7716cd3ecfc3f81a88f2d601',
        '818258209ad6ff292db8408a53efc8bf2a9e6815cdc430185a7716cd3ecfc3f81a88f2d602',
        '818258209ad6ff292db8408a53efc8bf2a9e6815cdc430185a7716cd3ecfc3f81a88f2d603',
        '818258209ad6ff292db8408a53efc8bf2a9e6815cdc430185a7716cd3ecfc3f81a88f2d604',
      ]),
    } as CardanoWalletAPI);
